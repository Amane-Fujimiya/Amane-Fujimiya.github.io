...
- If lights is bent by gravity, then what is exactly the "shape" of that region of space that lights being bent in? 
- Suppose you have a prediction. Let say, guess a number from $1-10$. Then give it to a sample of 1000 normal persons, and another one of 100 professional statisticians. What will be the accuracy of each sample, and what is the deviation? 
